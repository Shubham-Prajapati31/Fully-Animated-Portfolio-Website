      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-2/3">
            <form className="bg-white shadow-xl border border-gray-200 p-8 rounded-3xl flex flex-col gap-6 h-full">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 rounded-xl transition duration-300 shadow-md hover:shadow-lg mt-2 flex items-center justify-center"
              >
          ...
          <div className="md:w-1/3 bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-3xl shadow-lg border border-gray-100">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">+91 7304398xx </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">India , Maharashtra</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-white p-3 rounded-full shadow-md hover:bg-blue-50 transition">
                ...
                <a href="#" className="bg-white p-3 rounded-full shadow-md hover:bg-blue-400 transition">
                ...
                <a href="#" className="bg-white p-3 rounded-full shadow-md hover:bg-red-50 transition">

...
<section id="Projects" className="bg-white text-gray-800 py-16 px-6">
  <div className="max-w-6xl mx-auto">
    <h2 className="text-4xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 mb-12">Projects</h2>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div className="bg-gray-50 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-4">Smart AI tool to auto-generate conflict-free timetables using Python.</p>
          <span className="text-blue-500 text-sm">Python • Flask • AI</span>
          <div className="mt-4 flex gap-4">
            <a href="https://spdccollege2.netlify.app/" className="text-blue-600 hover:underline">Live Demo</a>
      ...
      <div className="bg-gray-50 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-4">Animated and responsive website for college with multi-page support.</p>
          <span className="text-blue-500 text-sm">HTML • CSS • JavaScript</span>
          <div className="mt-4 flex gap-4">
            <a href="https://ai-time-table.netlify.app/" className="text-blue-600 hover:underline">Live Demo</a>
            <a href="#" className="text-gray-600 hover:underline">GitHub</a>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-4">A fun arcade-style shooting game built using Pygame library.</p>
